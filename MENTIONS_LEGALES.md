...
Le site Need's it est une application web développée avec **Next.js** et déployée sur l'infrastructure suivante :

### 2.1. Hébergeur de l'application web
...
Need's it met en œuvre les moyens raisonnables pour assurer l'accès au service 24 h/24 et 7 j/7, sous réserve des opérations de maintenance et des cas de force majeure.

---

## 4. Description du service

Need's it est une **plateforme de mise en relation** entre :

- des **particuliers** qui déposent une demande de dépannage ou de service à domicile via un formulaire en ligne ;
- des **professionnels** référencés par Need's it, contactés par e-mail et accédant aux demandes via un lien sécurisé.

**Need's it n'exécute pas directement les prestations** réalisées par les professionnels. Le contrat de prestation est conclu entre le client et le professionnel. Need's it facilite la mise en relation et le suivi administratif de l'activité des professionnels référencés.
...
Les logos officiels de l'application sont hébergés dans le dossier `public/` du projet (`logo.png`, `logo-dark.png`).
...
- des **cookies de session** pour l'authentification des administrateurs (Supabase Auth) ;
- le **stockage local du navigateur** pour la préférence d'affichage clair/sombre (`needs-it-theme`).
...
L'utilisation du site est soumise aux **[Conditions Générales d'Utilisation](./CGU.md)**.

---

## 9. Limitation de responsabilité

Need's it agit en qualité d'**intermédiaire de mise en relation**. À ce titre :

- Need's it ne garantit pas la disponibilité immédiate d'un professionnel pour chaque demande ;
- Need's it ne contrôle pas la qualité des prestations réalisées par les professionnels ;
- Need's it ne saurait être tenue responsable des dommages résultant d'une mauvaise utilisation du site ou d'un litige entre un client et un professionnel, dans les limites autorisées par la loi.

Les informations diffusées sur le site sont fournies à titre indicatif. Need's it s'efforce d'en assurer l'exactitude mais ne peut garantir l'absence d'erreur ou d'omission.

---

## 10. Liens hypertextes

Le site peut contenir des liens vers des sites tiers (notamment les services techniques utilisés). Need's it n'exerce aucun contrôle sur le contenu de ces sites et décline toute responsabilité quant à leur contenu ou à leurs pratiques.
...
**Langue :** les présentes mentions sont rédigées en français. En cas de traduction, seule la version française fait foi.
...
| **Notifications internes**      | Telegram (optionnel) — [https://telegram.org](https://telegram.org)                       |
